...
class AuthenticatesControllerTest < ActionController::TestCase
  ...
  test "should create authenticate" do
    assert_difference('Authenticate.count') do
      post :create, authenticate: { provider: @authenticate.provider, uid: @authenticate.uid, user_id: @authenticate.user_id }
    end
  ...
  test "should update authenticate" do
    patch :update, id: @authenticate, authenticate: { provider: @authenticate.provider, uid: @authenticate.uid, user_id: @authenticate.user_id }
    assert_redirected_to authenticate_path(assigns(:authenticate))
  end
